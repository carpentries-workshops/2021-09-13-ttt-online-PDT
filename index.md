...
humandate: "September 13-16, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 AM - 1:00 PM PT"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Melissa Ko", "J. C. Szamosi"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["mesako@stanford.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
Participants must have a computer that is connected to the Internet and has a
functioning browser to access Google documents. Participants will also need to
be able to use Zoom videoconferencing with audio and video. Please ensure that you
have a working microphone and webcam to support these functionalities.
